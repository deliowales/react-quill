...
var ReactQuillV2Tables = /** @class */ (function (_super) {
    __extends(ReactQuillV2Tables, _super);
    function ReactQuillV2Tables(props) {
    ...
    ReactQuillV2Tables.prototype.validateProps = function (props) {
    ...
    ReactQuillV2Tables.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        var _this = this;
        var _a;
    ...
    ReactQuillV2Tables.prototype.shouldComponentRegenerate = function (nextProps) {
        var _this = this;
    ...
    ReactQuillV2Tables.prototype.componentDidMount = function () {
        this.instantiateEditor();
        this.setEditorContents(this.editor, this.getEditorContents());
    };
    ReactQuillV2Tables.prototype.componentWillUnmount = function () {
        this.destroyEditor();
    };
    ReactQuillV2Tables.prototype.componentDidUpdate = function (prevProps, prevState) {
        var _this = this;
    ...
    ReactQuillV2Tables.prototype.instantiateEditor = function () {
        if (this.editor)
            return;
        this.editor = this.createEditor(this.getEditingArea(), this.getEditorConfig());
    };
    ReactQuillV2Tables.prototype.destroyEditor = function () {
        if (!this.editor)
            return;
    ...
    */
    ReactQuillV2Tables.prototype.isControlled = function () {
        return 'value' in this.props;
    };
    ReactQuillV2Tables.prototype.getEditorConfig = function () {
        return {
    ...
    ReactQuillV2Tables.prototype.getEditor = function () {
        if (!this.editor)
    ...
    */
    ReactQuillV2Tables.prototype.createEditor = function (element, config) {
    ...
    ReactQuillV2Tables.prototype.hookEditor = function (editor) {
    ...
    ReactQuillV2Tables.prototype.unhookEditor = function (editor) {
        editor.off('editor-change', this.onEditorChange);
    };
    ReactQuillV2Tables.prototype.getEditorContents = function () {
        return this.value;
    };
    ReactQuillV2Tables.prototype.getEditorSelection = function () {
        return this.selection;
    };
    /*
    True if the value is a Delta instance or a Delta look-alike.
    */
    ReactQuillV2Tables.prototype.isDelta = function (value) {
        return value && value.ops;
    };
    /*
    Special comparison function that knows how to compare Deltas.
    */
    ReactQuillV2Tables.prototype.isEqualValue = function (value, nextValue) {
    ...
    */
    ReactQuillV2Tables.prototype.setEditorContents = function (editor, value) {
        var _this = this;
        this.value = value;
    ...
    ReactQuillV2Tables.prototype.setEditorSelection = function (editor, range) {
    ...
    ReactQuillV2Tables.prototype.setEditorTabIndex = function (editor, tabIndex) {
        var _a;
        if ((_a = editor === null || editor === void 0 ? void 0 : editor.scroll) === null || _a === void 0 ? void 0 : _a.domNode) {
            editor.scroll.domNode.tabIndex = tabIndex;
        }
    };
    ReactQuillV2Tables.prototype.setEditorReadOnly = function (editor, value) {
        if (value) {
            editor.disable();
        }
        else {
    ...
    */
    ReactQuillV2Tables.prototype.makeUnprivilegedEditor = function (editor) {
        var e = editor;
        return {
    ...
    ReactQuillV2Tables.prototype.getEditingArea = function () {
        if (!this.editingArea) {
    ...
    */
    ReactQuillV2Tables.prototype.renderEditingArea = function () {
        var _this = this;
    ...
    ReactQuillV2Tables.prototype.render = function () {
        var _a;
    ...
    ReactQuillV2Tables.prototype.onEditorChangeText = function (value, delta, source, editor) {
        var _a, _b;
        if (!this.editor)
            return;
    ...
    ReactQuillV2Tables.prototype.onEditorChangeSelection = function (nextSelection, source, editor) {
    ...
    ReactQuillV2Tables.prototype.focus = function () {
        if (!this.editor)
            return;
        this.editor.focus();
    };
    ReactQuillV2Tables.prototype.blur = function () {
        if (!this.editor)
            return;
        this.selection = null;
        this.editor.blur();
    };
    ReactQuillV2Tables.displayName = 'React Quill';
    /*
    Export Quill to be able to call `register`
    */
    ReactQuillV2Tables.Quill = quill_1.default;
    ReactQuillV2Tables.defaultProps = {
        theme: 'snow',
        modules: {},
        readOnly: false,
    };
    return ReactQuillV2Tables;
...
module.exports = ReactQuillV2Tables;
